  ...
  const migrations: Array<{ version: number; sql: string }> = [
    {
      ...
      sql: `
        CREATE TABLE IF NOT EXISTS reminders (
          ...
          remind_type     TEXT    NOT NULL DEFAULT 'interval',
          ...
          channels        TEXT    NOT NULL DEFAULT '["desktop"]',
          is_active       INTEGER NOT NULL DEFAULT 1,
          last_triggered_at TEXT  DEFAULT NULL,
          next_trigger_at   TEXT  DEFAULT NULL,
        ...
        INSERT OR IGNORE INTO settings (key, value) VALUES ('launch_at_startup', 'false');
        ...
        INSERT OR IGNORE INTO settings (key, value) VALUES ('scheduler_interval', '60');
        INSERT OR IGNORE INTO settings (key, value) VALUES ('api_port', '33333');
    ...
    },
    {
      version: 3,
      sql: `
        ALTER TABLE reminders ADD COLUMN weekdays TEXT DEFAULT NULL;
        ALTER TABLE reminders ADD COLUMN workday_only INTEGER NOT NULL DEFAULT 0;
    ...
    },
    {
      version: 4,
      sql: `
        ALTER TABLE reminders ADD COLUMN holiday_only INTEGER NOT NULL DEFAULT 0;
        ALTER TABLE reminders ADD COLUMN lunar_date TEXT DEFAULT NULL;
      `
    },
    {
      version: 5,
